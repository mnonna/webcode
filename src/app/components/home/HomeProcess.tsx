...
export default function HomeProcess() {
  ...
  useEffect(() => {
    ...
    const previousIndex = previousDesktopIndexRef.current;
    ...
    desktopFadeTimeoutRef.current = window.setTimeout(() => {
      setTransitioningFromIndex((current) => (current === previousIndex ? null : current));
      desktopFadeTimeoutRef.current = null;
    }, 260);
            ...
            <div className="absolute inset-0">
              {processSlides.map((slide, index) => (
                <div
                  ...
                  className={clsx('absolute inset-0', index !== activeIndex && index !== transitioningFromIndex && 'pointer-events-none')}
                  style={{
                    opacity: index === activeIndex ? 1 : 0,
                    visibility: index === activeIndex || index === transitioningFromIndex ? 'visible' : 'hidden',
                    ...
                    transition:
                      index === activeIndex
                        ...
                        : index === transitioningFromIndex
                          ...
                          : 'none',
                    willChange: index === activeIndex || index === transitioningFromIndex ? 'transform, opacity' : 'auto',
                  }}
