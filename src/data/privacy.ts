export const privacyPolicy = `
        ...
        <ol>
          <li>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: <b>https://webcode.com.pl</b></li>
          <li>
            Operatorem serwisu oraz Administratorem danych osobowych jest: Webcode Marcin Nonna Cyprysowa 30A/1, 62-052, Komorniki 
             
              NIP:7792533418, REGON:520691007 
                      </li>

                      <li>Adres kontaktowy poczty elektronicznej operatora: webcode.kontakt@gmail.com</li>
...
komputerze użytkownika i mogą być odczytane jedynie na docelowym serwerze.</li>
        ...
        <h2>3. Hosting</h2>
        <ol>
                    <li>Serwis jest hostowany (technicznie utrzymywany) na serwerze operatora: https://contabo.com/en/</li>
